  ...
  return (
    ...
    <header className={`h-14 bg-white dark:bg-[#0D1117] border-b border-neutral-100 dark:border-[#30363D] px-4 lg:px-6 flex items-center justify-between sticky ${isOnline ? 'top-0' : 'top-7'} z-30`}>
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Project Switcher - hidden in platform mode */}
        {!location.pathname.startsWith('/super-admin') ? (
          <ProjectSwitcher />
        ) : (
          <span className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium text-[#4F46E5] dark:text-[#818CF8] bg-[#4F46E5]/8 dark:bg-[#6366F1]/12 rounded-md">
