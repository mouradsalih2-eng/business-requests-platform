...
export function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block w-56 bg-white border-r border-neutral-100 min-h-[calc(100vh-3.5rem)] flex-shrink-0">
      ...
      <aside
        className={`
          fixed top-14 left-0 bottom-0 w-64 bg-white border-r border-neutral-100
